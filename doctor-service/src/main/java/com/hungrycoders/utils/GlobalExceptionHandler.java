...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GenericResponse<List<String>>> handleValidationExceptions(
    ...
    public ResponseEntity<GenericResponse<String>> handleInvalidDoctorStatusException(InvalidDoctorStatusException ex) {
        return new ResponseEntity<>(
                new GenericResponse<>("Validation failed: " + ex.getMessage()), HttpStatus.BAD_REQUEST);
    }
}
