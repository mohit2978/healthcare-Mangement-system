...
public class DoctorController {
    ...
    @PostMapping
    public ResponseEntity<?> saveDoctor(@Valid @RequestBody com.hungrycoders.payload.request.Doctor doctor)
            throws Exception {
        try {
    ...
    public ResponseEntity<?> updateDoctor(
            @Valid @RequestBody com.hungrycoders.payload.request.Doctor doctor, @PathVariable String id)
            throws Exception {
        try {
