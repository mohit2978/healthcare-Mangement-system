...
3. **Configure Email Settings**  
   Update the relevant compose file with the following environment variables for email functionality:
    - `MAIL_SERVER_HOST`: e.g., `smtp.gmail.com`
    - `MAIL_SERVER_PORT`: e.g., `1025`
...
- In prod mode, runtime configuration is loaded from centralized config server via `admin-service`.
